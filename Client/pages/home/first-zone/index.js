  ...
  render() {
    ...
    return (
      <div className="firstZone" id="firstZoneId">
        ...
        {isLoaded && (
          <Fragment>
            <div className="value1" id="welcome-text-1">
              ĐÂY LÀ THẾ GIỚI RIÊNG CỦA BẠN
            </div>
            <div className="value2" id="welcome-text-2">
              Bạn có thể xây dựng trang cá nhân ngay bây giờ!
            </div>
