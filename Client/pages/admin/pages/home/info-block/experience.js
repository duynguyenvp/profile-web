...
const getTitle = (company, position, city) => {
    let title = company && position && `Làm ${position} tại ${company}` || 'Chưa có thông tin'
...
const ExperienceInfoBlock = ({ portfolioId, experience, handleRemoveExperience, handleSaveExperience }) => {
