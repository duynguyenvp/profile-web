...
import { useServiceStore, removeService, setServices } from '../../store/serviceStore'
        ...
        <Fragment>
            ...
            <Row style={{ marginTop: 30 }}>
                ...
                >
                    ...
                    <Column title="Mô tả" dataIndex="serviceDescription" key="serviceDescription" />
                    <Column
                        title=""
                        key="action"
                        width={56}
            ...
            <ServicePopup onClose={closePopup} visible={popupVisible} service={selectedService} />
        </Fragment>
    );
}
